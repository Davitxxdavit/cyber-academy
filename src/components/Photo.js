...
import courseImage from "../asets/course-img2.jpeg"; 
import syllabusPdf from "../asets/silabus-rast.docx"; 
...
import mentor from '../asets/mentors5.jpeg';
...
const [arrowDown5, setArrowDown5] = useState(false);
  ...
  const handleDownloadSyllabus = () => {
    ...
    link.download = 'Rast_Sylabus.docx'; // Ensure the correct file format
      ...
      <div className={styles.container}>
        ...
        <div className={styles.mainInnerEdited}>
            ...
            <div className={styles.rightFirst}>
              ...
              strings={[
                'ფოტოგრაფია, ფოტოჟურნალისტიკა, ფოტოგრაფია მარკეტინგში',
                'ფოტოგრაფია, ფოტოჟურნალისტიკა, ფოტოგრაფია მარკეტინგში'
                ]}
                typeSpeed={90}
                backSpeed={100}
              ...
              <ul>
                ...
                <li>ფოტოგრაფია მარკეტინგში</li>
                <li>ფოტოგრაფიის აპარატურა და მისი შერჩევის თავისებურებები</li>
                <li>ფოტოს რეჟიმები</li>
                <li>სწორი რაკურსის შერჩევა</li>
                <li>ფოტოს თემატიკები და რასტრული გრაფიკა</li>
              </ul>
            </div>
        </div>
