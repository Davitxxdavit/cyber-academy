...
import courseImage from '../asets/microsoftsuite.webp';
function MicrosoftSuite() {
        ...
        <div className={styles.mainInnerEdited}>
           <motion.div
            ...
            <div className={styles.rightFirst}>
              ...
              <p>microsoft Office Suites-ის გმოყენება Word, Exel, Pdf, PowerPoint-ის ფუნქციები; ელექტრონული ხელმოწერა და შტამპი ,კიბერ აკადემია გთავაზობთ შესაძლებლობას შეისწავლოთ დღეისთვის სწრაფად განვითარებადი დარგი ვებ გვერდების.
