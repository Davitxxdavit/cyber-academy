...
import courseImage from "../asets/course-2.jpg"; // Adjust the path as needed
...
const [isClicked, setIsClicked] = useState(false);
  ...
  const handleDownloadSyllabus = () => {
    ...
    link.download = 'Graphics_Syllabus.docx'; // Ensure the correct file format
        ...
        <div className={styles.mainInnerEdited}>
            ...
            <div className={styles.rightFirst}>
              ...
              <ul>
                ...
                <li>რასტრული გრაფიკა პროგრამა Adobe Photoshop-ის ბაზაზე</li>
                <li>ვექტორული გრაფიკა პროგრამა Adobe Illustrator, CorelDraw-ის ბაზაზე</li>
                <li>3D მოდელირება</li>
