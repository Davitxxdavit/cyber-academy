...
import mentor from '../asets/mentors1.jpeg';
...
const [isClicked, setIsClicked] = useState(false);
  ...
  const handleDownloadSyllabus = () => {
    ...
    link.download = 'Web_Technologies_Syllabus.pdf';
        ...
        <div className={styles.mainInnerEdited}>
            ...
            <div className={styles.rightFirst}>
              ...
              <ul>
                ...
                <li>პერსონელური კომპიუტერის აპარატურული და პროგრამული უზრუნველყოფა</li>
                <li>კომპიუტერული ქსელების აპარატურული და პროგრამული უზრუნველყოფა</li>
                <li>მნიშვნელოვანი საფუძველი მომავალი განვითარებისთვის</li>
                <li>პრაქტიკული გამოცდილება</li>
              </ul>
            </div>
        </div>
