...
import courseImage from '../asets/google-workspace.jpg';
        ...
        <div className={styles.mainInnerEdited}>
           <motion.div
            ...
            <div className={styles.rightFirst}>
              ...
              <p>Google Workspace-ის ინსტრუმენტების გამოყენება (Google Drive, Docs, Sheets, Slides და google Calendar-ის ეფექტური გამოყენება),კიბერ აკადემია გთავაზობთ შესაძლებლობას შეისწავლოთ დღეისთვის სწრაფად განვითარებადი დარგი ვებ გვერდების.
